            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white max-w-4xl px-6">
                  ...
                  <h2 className="text-2xl mb-6 font-bold text-balance text-amber-100">{image.title}</h2>
                  <p className="text-xl mb-8 text-pretty text-gray-100">{image.description} - Université d'Antananarivo</p>
                  <div className="flex items-center justify-center gap-x-6">
                    <Button asChild size="lg" className=" text-gray-500 bg-gradient-to-r from-purple-200 to-amber-100 hover:from-purple-500 hover:to-purple-600 border-0 shadow-lg">
