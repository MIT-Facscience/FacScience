        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-purple-50 hover:bg-gradient-to-br hover:from-purple-600 hover:to-purple-700 rounded-full flex items-center justify-center transition-all duration-300 group border border-purple-200/50"
              >
              ...
              <div className="flex items-start space-x-3 group">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-xs text-slate-600 hover:text-purple-700 transition-colors"
                  >
                    +261 20 12 345 67
                  </a>
                </div>
