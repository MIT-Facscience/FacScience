  ...
  const masters = [
    {
      ...
      description:
        "Spécialisation en modélisation mathématique et calcul scientifique",
      debouches:
        "Ingénieur de recherche, Consultant en modélisation, Enseignant-chercheur",
    },
    {
    ...
    },
    {
      ...
      description:
        "Spécialisation en science des données et intelligence artificielle",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Formation d'excellence en mathématiques et sciences
                informatiques
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li>
                        • <strong>Série du Bac:</strong> C ou D (Mathématiques
                        obligatoires)
                      </li>
                      <li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li>
                        • <strong>L2:</strong> Validation L1 (60 ECTS) ou
                        équivalent
                      </li>
                      <li>
                        • <strong>L3:</strong> Validation L2 (120 ECTS) ou
                        équivalent
                      </li>
                      <li>
                        • <strong>M1:</strong> Licence en Math/Info ou
                        équivalent
                      </li>
                      <li>
