  ...
  return (
    <div className="text-center space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-faculty-purple-50 border border-faculty-purple-200  p-4">
      ...
      {/* Application Summary */}
      <div className="bg-gray-50  p-6 text-left space-y-3">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
        <button
          ...
          className="flex items-center justify-center px-6 py-3 border border-faculty-purple-600 text-faculty-purple-600  hover:bg-purple-50 transition-colors duration-200"
        >
        ...
        <button
          onClick={onComplete}
          className="px-6 py-3 bg-faculty-purple-600 text-white  hover:bg-faculty-purple-700 transition-colors duration-200"
        >
