              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                  ...
                  <Card className="border-0 rounded-none">
                    <CardHeader>
                      <CardTitle>
                        Conditions d'admission par série de baccalauréat
                      </CardTitle>
                      <CardDescription>
                        Les admissions sont organisées selon la série du
                        baccalauréat et la mention obtenue
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Accordion type="single" collapsible className="w-full">
                          ...
                          <AccordionContent className="space-y-4">
                            <div className="space-y-3">
                              <div className="border-l-4 border-l-primary pl-4 py-2">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Accès direct à toutes les mentions de la
                                  Faculté
                                </p>
                              </div>
                              ...
                              <div className="border-l-4 border-l-accent pl-4 py-2">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Admission selon les places disponibles et
                                  classement
                                </p>
                              </div>
                              <div className="border-l-4 border-l-gray-400 pl-4 py-2">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Admission limitée selon disponibilité et
                                  classement
                                </p>
                              </div>
                            </div>
                        ...
                        <AccordionItem value="technique">
                          ...
                          <AccordionContent className="space-y-4">
                            <div className="space-y-3">
                              <p className="text-sm">
                                Les titulaires de baccalauréats techniques
                                peuvent postuler pour certaines mentions :
                              </p>
