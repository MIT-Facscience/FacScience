        ...
        <div className="bg-purple-50 p-6 border border-purple-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-primary">{professors.length}</p>
            </div>
        ...
        <div className="bg-white shadow-sm border border-slate-200 p-2  mt-8 mb-8">
          <div className="flex space-x-2">
            {[
              ...
              { id: 'staff', label: 'Personnels', icon: UserCheck, count: staff.length }
            ].map(tab => (
              <button
                key={tab.id}
              ...
              <div className="flex bg-slate-100 p-1">
                <button
                  ...
                  className={`p-2 transition-all ${
                    viewMode === 'grid' ? 'bg-primary text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
                  }`}
                >
                ...
                <button
                  ...
                  className={`p-2 transition-all ${
                    viewMode === 'list' ? 'bg-primary text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
                  }`}
                >
