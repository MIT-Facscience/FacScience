  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
            {[
              ...
              <button
                ...
                className={`flex items-center justify-center sm:justify-start px-4 sm:px-6 py-3 sm:py-4 font-medium transition-all duration-300  w-full sm:w-auto ${
                  activeTab === tab.id
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 border border-slate-300  focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
              />
              {searchTerm && (
                <button
                  onClick={clearSearch}
          ...
          >
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <button
                ...
                className={`flex items-center px-3 py-2  border transition-colors ${
                  currentPage === 1
                ...
                {getPaginationRange().map((page, index) =>
                  page === "..." ? (
                    ...
                    <button
                      ...
                      className={`w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center  border transition-colors text-sm ${
                        currentPage === page
            ...
            <div className="bg-white border border-slate-200  p-4 shadow-sm">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-20 px-3 py-2 border border-slate-300  text-center focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
      ...
      {searchTerm && filteredData.length === 0 && (
        <div className="fixed bottom-4 left-4 right-4 sm:left-auto sm:w-96 bg-white border border-slate-200  shadow-lg p-4 z-40">
